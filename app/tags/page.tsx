  ...
  return (
    <main className="mx-auto max-w-5xl px-6 pb-16 pt-12 text-white md:px-8">
      <header className="mb-10 rounded-2xl border border-white/10 bg-white/[0.03] p-7 backdrop-blur">
        ...
        <h1 className="mt-2 text-4xl font-semibold">태그 아카이브</h1>
          ...
          {tags.map(({ tag, count }) => (
            <li key={tag}>
              <Link
                ...
                className="group flex items-center justify-between rounded-2xl border border-white/10 bg-black/25 px-4 py-3 transition hover:border-cyan-300/35 hover:bg-black/35"
              >
